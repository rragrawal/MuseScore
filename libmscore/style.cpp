...
static const StyleTypes2 styleTypes2[] = {
      ...
      { StyleIdx::swingOn,                     StyleType("swingOn",                 StyleValueType::BOOL)  },
      { StyleIdx::swingEighth,                 StyleType("swingEighth",             StyleValueType::BOOL)  },
      { StyleIdx::swingSixteenth,              StyleType("swingSixteenth",          StyleValueType::BOOL)  },
...
StyleData::StyleData()
   : _values(int(StyleIdx::STYLES))
      ...
      static const StyleVal2 values2[] = {
            ...
            { StyleIdx::bracketDistance,             QVariant(0.8) },
            ...
            { StyleIdx::beamMinLen,                  QVariant(1.316178) },      // exactly note head width
            ...
            { StyleIdx::fretNumMag,                  QVariant(qreal(2.0)) },
            ...
            { StyleIdx::smallNoteMag,                QVariant(qreal(.7)) },
            ...
            { StyleIdx::swingOn,                     QVariant(false) },
            { StyleIdx::swingEighth,                 QVariant(true)  },
            { StyleIdx::swingSixteenth,              QVariant(false) },
        //    { StyleIdx::swingUnit,                   QVariant("eighth")},
